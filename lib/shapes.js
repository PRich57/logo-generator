...
class Triangle extends Shapes {
  ...
  render() {
    return `<svg width='300' height='200'><polygon points="150, 18 244, 182 56, 182" fill="${this.shapeColor}" /><text x="148" y="165" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.text}</text></svg>`
  }
}
