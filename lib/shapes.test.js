...
describe('shapes testing suite', () => {
  ...
  describe('testing Triangle class', () => {
    it('render method produces proper template', () => {
      ...
      const textColor = 'white';
      const text = 'svg';
      const testTemplate = `<svg width='300' height='200'><polygon points="150, 18 244, 182 56, 182" fill="${shapeColor}" /><text x="148" y="165" font-size="60" text-anchor="middle" fill="${textColor}">${text}</text></svg>`;
