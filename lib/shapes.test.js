...
describe('shapes testing suite', () => {
  ...
  describe('testing Circle class', () => {
    it('render method produces proper template', () => {
      ...
      const text = 'svg';
      const testTemplate = `<svg width="300" height="200"><circle cx="150" cy="100" r="80" fill="${shapeColor}"/><text x="148" y="120" font-size="60" text-anchor="middle" fill="${textColor}">${text}</text></svg>`;
  ...
  describe('testing Square class', () => {
    it('render method produces proper template', () => {
      ...
      const textColor = 'white';
      const text = 'svg';
      const testTemplate = `<svg width="300" height="200"><rect width="150" height="150" x='70' fill='${shapeColor}'/><text x="144" y="94" font-size="60" text-anchor="middle" fill="${textColor}">${text}</text></svg>`;
  ...
  describe('testing Triangle class', () => {
    it('render method produces proper template', () => {
      ...
      const textColor = 'white';
      const text = 'svg';
      const testTemplate = `<svg width='300' height='200'><polygon points="150, 18 244, 182 56, 182" fill="${shapeColor}" /><text x="149" y="165" font-size="60" text-anchor="middle" fill="${textColor}">${text}</text></svg>`;
